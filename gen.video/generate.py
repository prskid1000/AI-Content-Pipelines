...
SCRIPT_ARGS = {
    ...
    "12.youtube.py": ["--video-file", "../../gen.video/output/final.mp4", "--upload-shorts", "--shorts-dir", "../../gen.audio/output"],
}
...
def start_comfyui(working_dir: str, log_handle) -> subprocess.Popen:
    ...
    if os.name == "nt":
        ...
        proc = subprocess.Popen(
            [sys.executable, "main.py", "--disable-pinned-memory", "--async-offload", "16", "--use-flash-attention", "--lowvram", "--force-fp16", "--bf16-unet"],
            cwd=comfy_dir,
            stdout=log_handle,
            stderr=log_handle,
            text=True,
