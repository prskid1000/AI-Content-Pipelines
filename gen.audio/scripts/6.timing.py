...
MODEL_TIMING_GENERATION = "qwen3-30b-a3b-instruct-2507"  # Model for timing SFX generation
...
OUTPUT: JSON with realistic_duration_seconds and position_float fields. Only use English Language for Input, Thinking, abd Output\n/no_think"""
                    },
                    {
                        "role": "user",
