                    ...
                    "properties": {
                        "parts": {
                            ...
                            "items": {
                                ...
                                "required": ["title", "short_summary", "summary"]
                            }
                        }
                    },
                    "required": ["parts"]
...
{story_summary}"""
    ...
    def _parse_meta_summary_response(self, raw_response: str) -> dict:
        ...
        try:
            ...
            if isinstance(json_obj, dict) and "parts" in json_obj:
                ...
                for part in parts:
                    if "summary" in part:
                        part["summary"] = self._sanitize_single_paragraph(part["summary"])
    ...
    def generate_chapter_summaries(self, story_text: str, output_dir: str = "../input", resumable_state: ResumableState | None = None) -> list:
        ...
        merged_summary = " ".join([part.get("summary", "") for part in parts])
