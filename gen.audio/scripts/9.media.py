...
MODEL_MEDIA_TAGS = "qwen3-vl-30b-a3b-instruct"  # Model for generating YouTube tags
MODEL_MEDIA_TITLE = "qwen3-vl-30b-a3b-instruct"  # Model for generating YouTube titles
...
class DiffusionPromptGenerator:
    ...
    def _build_system_prompt(self) -> str:
        ...
        CONSTRAINTS: 
         ...
         - Include: MALE news anchors or reporters, with detailed physical descriptions and attire positioned specifically in the scene (center-left, background-right, etc.).
