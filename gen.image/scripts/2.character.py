...
class CharacterGenerator:
    ...
    def _update_workflow_prompt(self, workflow: dict, character_name: str, description: str) -> dict:
        """Update the workflow with character-specific prompt - OPTIMIZED FOR NEWS CHANNEL."""
        if FACE_ONLY:
            prompt = f"Create a 16K ultra-high-resolution, Dressed Face and upto Shoulders Visible, Professional News Broadcast Illustration in the style of {ART_STYLE} in which face(eyes, nose, mouth, skin, shoulders), precisely and accurately matching character with description and fine-level detailing, and any part not cropped or hidden. Character should have professional news anchor/reporter appearance with authoritative presence, confident expression, and broadcast-quality grooming appropriate for news and information channels.\n\n Character Description = {description}. Strictly, Accurately, Precisely, always must Follow {ART_STYLE} Style. All Colourings, Styles, Shapes, Textures, Lightings and Detailing, must be **exactly same/ identical/as it is** in the character text-description. Must use Black Background." + "\n __NOTE__:" + " ".join(EXTRA_PROMPT_PHRASES)
        else:
            prompt = f"Create a 16K ultra-high-resolution, Full DressedBody Visible, Professional News Broadcast Illustration in the style of {ART_STYLE} in which torso, limbs, hands, feet, face(eyes, nose, mouth, skin), clothes, ornaments, props, precisely and accurately matching character with description and fine-level detailing, and any part not cropped or hidden. Character should have professional news anchor/reporter appearance with authoritative presence, confident posture, professional business attire (suits, blazers, professional dress), and broadcast-quality grooming appropriate for news and information channels.\n\n Character Description = {description}. Strictly, Accurately, Precisely, always must Follow {ART_STYLE} Style. All Colourings, Styles, Shapes, Textures, Lightings and Detailing, must be **exactly same/ identical/as it is** in the character text-description. Must use Black Background." + "\n __NOTE__:" + " ".join(EXTRA_PROMPT_PHRASES)
