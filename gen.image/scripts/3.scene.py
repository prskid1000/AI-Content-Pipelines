    ...
    def _replace_character_references(self, scene_description: str, character_names: list[str], characters_data) -> str:
        ...
        def replace_character_func(match):
            ...
            if char_name in character_names:
                ...
                return f"\nUSE{ "," +position_desc if self.character_mode in ['IMAGE', 'IMAGE_TEXT'] else ''}, {characters_data[char_name][:(CHARACTER_WORD_LIMIT * WORD_FACTOR)] if self.character_mode in ['TEXT', 'IMAGE_TEXT'] else ''} to illustrate the scene"
            else:
