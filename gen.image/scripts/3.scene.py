...
class SceneGenerator:
    ...
    def _get_master_prompt(self) -> str:
        ...
        Illustrate each Character's Face and Body Features as well as entire Clothing as in the respective reference image, and character text-description though all other aspects like direction to look, pose, posture, props, etc. are adaptable to Scene text-description
