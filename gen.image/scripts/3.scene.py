...
class SceneGenerator:
    ...
    def _get_master_prompt(self) -> str:
        ...
        **PHYSICAL SIZE AND VISUAL SIZE, AND APPEARANCE OF CHARACTERS SHOULD BE RELATIVE TO THE SCENE AND ITS OBJECTS AND SHOULD NOT FOLLOW REAL WORLD PHYSICAL SIZE.**
