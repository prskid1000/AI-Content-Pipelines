...
class SceneGenerator:
    ...
    def _replace_location_references(self, scene_description: str, locations_data: dict[str, str]) -> str:
        ...
        # Only replace location references in TEXT and IMAGE_TEXT modes
...
Strictly, Accurately, Precisely, always must Follow {ART_STYLE} Style.
    ...
    def _build_dynamic_workflow(self, scene_id: str, scene_description: str, character_names: list[str], master_prompt: str, characters_data: dict[str, str], locations_data: dict[str, str] = None) -> dict:
        ...
        # Copy character images if in IMAGE or IMAGE_TEXT mode
        if self.character_mode in ["IMAGE", "IMAGE_TEXT"]:
        ...
        # Copy location images if in IMAGE or IMAGE_TEXT mode
        ...
        # Replace location references if location data is available and in appropriate mode
        ...
        # Add location details if in TEXT or IMAGE_TEXT mode
        ...
        try:
            ...
            for i, lora_config in enumerate(enabled_loras):
                ...
                if use_only_intermediate and i > 0:
                    ...
                    # Normal workflow with character and location images based on modes
