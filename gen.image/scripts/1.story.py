...
def _build_character_summary_prompt(character_name: str, detailed_description: str) -> str:
    return (
        f"Create a concise character single paragraph summary ({CHARACTER_SUMMARY_CHARACTER_MIN}-{CHARACTER_SUMMARY_CHARACTER_MAX} characters) for AI image generation in {ART_STYLE} style.\n\n"
        f"It must always include all visual details from the original description, preserving all visual attributes and characteristics.\n"
        f"Character: {character_name}\n\n"
...
def _build_story_description_prompt(story_content: str) -> str:
    return (
        f"Create a story single paragraph summary ({STORY_DESCRIPTION_CHARACTER_MIN}-{STORY_DESCRIPTION_CHARACTER_MAX} characters) for AI generation in {ART_STYLE} style.\n\n"
...
def _build_location_summary_prompt(location_id: str, detailed_description: str) -> str:
    return (
        f"Create a concise location single paragraph summary ({LOCATION_SUMMARY_CHARACTER_MIN}-{LOCATION_SUMMARY_CHARACTER_MAX} characters) for AI image generation in {ART_STYLE} style.\n\n"
