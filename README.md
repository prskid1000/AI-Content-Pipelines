...
- **LM Studio** (Port 1234) - Local language model (qwen3-30b-a3b) for text processing and content analysis
...
2. **LM Studio** - Local language model (qwen3-30b-a3b) 
...
# Model Configuration
MODEL_CHARACTER_CHAPTER_SUMMARY = "qwen3-30b-a3b"
MODEL_CHARACTER_TITLE_GENERATION = "qwen3-30b-a3b"
MODEL_CHARACTER_META_SUMMARY = "qwen3-30b-a3b"
...
2. Install LM Studio and load qwen3-30b-a3b model
3. Install FFmpeg
...
#### Model Configuration
- `LM_STUDIO_MODEL` - Model name (default: qwen3-30b-a3b)
...
### Model Configuration
- **LM Studio Model**: `qwen3-30b-a3b` (14B parameter language model)
